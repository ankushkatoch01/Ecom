...
while($row_product_price=mysqli_fetch_array($run_price)){
  ...
  // order pending
  $insert_pending_orders="insert into `order_panding` (user_id,invoice_number,product_id,quantity,order_status) values ($user_id,$invoice_number,$product_id,$quantity,'$status')";
  $result_panding_orders=mysqli_query($con, $insert_pending_orders);
