...
while($row=mysqli_fetch_assoc($result)){
    ...
    $number++;
        ...
        <tr class="text-center">
            ...
            <td><a href='index.php?delete_category=<?php echo $category_id?>' type="button" class="text-light" data-toggle="modal" data-target="#exampleModal"><i class='fa-solid fa-trash'></i></a></td></tr>
        <?php
