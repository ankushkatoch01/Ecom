...
while($row=mysqli_fetch_assoc($result)){
    ...
    <td><?php 
    $get_count="Select * from `order_panding` where product_id=$product_id";
    ...
    <td><a href='index.php?delete_product=<?php echo $product_id?>' type="button" class="text-light" data-toggle="modal" data-target="#exampleModal"><i class='fa-solid fa-trash'></i></a></td></tr>
</tr>
<?php
}
?>
